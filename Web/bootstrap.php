...
require __DIR__.'/../lib/AyolyanFram/SplClassLoader.php';

// On va ensuite enregistrer les autoloads correspondant à chaque vendor (OCFram, App, Model, etc.)
$OCFramLoader = new SplClassLoader('AyolyanFram', __DIR__.'/../lib');
...
$navBuilderLoader = new SplClassLoader('NavBuilder', __DIR__.'/../lib/vendors');
$navBuilderLoader->register();
