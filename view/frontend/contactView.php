...
<section>
    ...
    <form action="recevoir_donnees_formulaire.html" method="get">
        <div>
        ...
        <div>
            ...
            <input type="text" name="sujet" id="sujet" placeholder="Le sujet de votre message" />
        </div>
    ...
    <section>
        ...
        <ul>
            <li>
                ...
                <a href="https://twitter.com/Ay0lyan">@Ay0lyan</a>
            </li>
        </ul>
    </section>
</section>
